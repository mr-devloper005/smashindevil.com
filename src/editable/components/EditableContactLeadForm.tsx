...
export function EditableContactLeadForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-[2rem] border border-[var(--editable-border)] bg-white/90 p-6 shadow-2xl shadow-black/5 backdrop-blur md:p-8">
      ...
      <button type="submit" disabled={status === 'submitting'} className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[#2f1d16] px-6 text-sm font-black uppercase tracking-[0.24em] text-[#fff7ee] shadow-lg transition hover:-translate-y-0.5 hover:bg-[#3a241b] disabled:cursor-not-allowed disabled:opacity-70">
